...
export default function Pricing() {
  ...
  <div className="max-w-6xl mx-auto px-6 text-center">
    <h3 className="text-3xl md:text-4xl font-bold mb-6">Pricing</h3>
    ...
    <div className="grid md:grid-cols-3 gap-6">
      <div className="border p-6 rounded-xl shadow hover:shadow-lg transition">
        <h4 className="font-semibold mb-2 text-lg">Land Acquisition</h4>
      ...
      <div className="border p-6 rounded-xl shadow hover:shadow-lg transition">
        <h4 className="font-semibold mb-2 text-lg">Property Development</h4>
      ...
      <div className="border p-6 rounded-xl shadow hover:shadow-lg transition">
        <h4 className="font-semibold mb-2 text-lg">Full Concierge</h4>
